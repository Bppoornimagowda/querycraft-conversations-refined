  ...
  return (
    <div className="w-64 lg:w-72 h-full bg-sidebar flex flex-col border-r border-sidebar-border">
      ...
      <div className="flex-1 overflow-y-auto">
        {chats
          .filter(chat => activeTab === "history" || chat.bookmarked)
          ...
          {chats.filter(chat => activeTab === "history" || chat.bookmarked).length === 0 && (
            <div className="px-4 py-8 text-center text-muted-foreground text-sm">
              {activeTab === "history" ? (
                ...
                <>
                  ...
                  <p>No bookmarked chats</p>
                  <p className="mt-1 text-xs">Bookmark important conversations to find them here</p>
                </>
              )}
            </div>
          )}
